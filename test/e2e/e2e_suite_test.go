...
var (
	...
	skipPrometheusInstall  = os.Getenv("PROMETHEUS_INSTALL_SKIP") == trueString
	...
	projectImage = "example.com/falco-operator:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting falco-operator integration test suite\n")
...
var _ = BeforeSuite(func() {
	...
	cmd := exec.Command("make", "docker-build", "OPERATOR=falco", fmt.Sprintf("IMG=%s", projectImage))
	_, err := utils.Run(cmd)
