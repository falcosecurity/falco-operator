...
fmt: gci addlicense ## Run go fmt against code.
	...
	find . -type f -name '*.go' ! -path './zz_generated*' -a ! -exec grep -q '// Code generated by' {} \; -exec sed -i -E 's|// Copyright ([0-9]{4}) \(C\) The Falco Authors|// Copyright (C) \1 The Falco Authors|' {} +
